...
# Determine the root directory (factShare) and load .env
...
API_KEY = os.getenv("GOOGLE_CUSTOM_SEARCH_API_KEY") # Modified
SEARCH_ENGINE_ID = os.getenv("GOOGLE_SEARCH_ENGINE_ID") # Modified - Assuming this should also be in .env
...
if __name__ == "__main__":
    # Run the Flask app on a different port, e.g., 5001
    debug_mode = os.getenv("FLASK_DEBUG", "false").lower() == "true"
    port = int(os.getenv("FLASK_APP_PY_PORT", 5001)) # Use environment variable for port or default to 5001
